...
# **** Fixes
# Some projects dangerouslky extend the browserlist config, this env var
# suppresses that error in eslint.
# #+begin_src elisp
# (setq process-environment '("DIRENV_CONFIG=/Users/tibor.pilz/.config/direnv"))
# #+end_src
